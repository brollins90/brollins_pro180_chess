...
public class BoardPanel extends JPanel {
    ...
    private Color LIGHT_SQUARE_COLOR = Color.WHITE;
    private Color DARK_SQUARE_COLOR = Color.GRAY;
    ...
    public void paint(Graphics g) {
        ...
        int numberOfRows = this.m.currentBoard.getBoardSize();
        int numberOfCols = this.m.currentBoard.getBoardSize();
        for (int rowIndex = numberOfRows - 1; rowIndex > -1; rowIndex--) {
            ...
            for (int colIndex = 0; colIndex < numberOfCols; colIndex++) {
                ...
                Piece temp = this.m.getPiece(currentLocation);
                ...
                if(this.availableDestinations.contains(currentLocation)) {
